  ...
  return (
    <footer className="footer-container">
      ...
      <div className="footer-content">
        <div className="footer-column p-4 pt-5">
        ...
        <div className="footer-column p-5">
        ...
        <div className="footer-column p-5">
          ...
          <Link to="/terms" style={{color:'white'}}>Terms and Conditions</Link>
          <Link to="/privacy" style={{color:'white'}}>Privacy Policy</Link>
          <Link to="/accessibility" style={{color:'white'}}>Accessibility Statement</Link>
